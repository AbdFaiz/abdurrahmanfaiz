...
export const listTools: Tool[] = [
  ...
  { id: 8, name: "Astro", icon: "/assets/tools/astro.svg" },
  { id: 9, name: "jQuery", icon: "/assets/tools/jquery.svg" },
  { id: 10, name: "Node.js", icon: "/assets/tools/nodejs.svg" },
  { id: 11, name: "Laravel", icon: "/assets/tools/laravel.svg" },
  { id: 12, name: "Python", icon: "/assets/tools/python.svg" },
  { id: 13, name: "Node-red", icon: "/assets/tools/nodered.svg" },
  { id: 14, name: "Ubuntu", icon: "/assets/tools/ubuntu.svg" },
];
