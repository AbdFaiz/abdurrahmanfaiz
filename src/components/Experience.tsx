...
export default function Experience() {
  return (
    <section id="experience" className="py-24 px-4 sm:px-6 lg:px-8 bg-[#f5f1ea]">
      <div className="max-w-7xl mx-auto">
        {/* Section Header */}
        <div className="mb-20 text-center">
          <div className="inline-flex items-center gap-3 mb-4">
            <div className="h-px w-10 bg-[#8b4513]"></div>
        ...
        <div className="relative">
          ...
          <div className="absolute left-1 top-0 bottom-0 w-px bg-gradient-to-b from-[#8b4513]/20 via-[#8b4513]/10 to-transparent"></div>
          <div className="absolute right-0 top-0 bottom-0 w-px bg-gradient-to-b from-[#8b4513]/20 via-[#8b4513]/10 to-transparent"></div>
            ...
            {listExperience.map((exp, index) => (
              ...
              >
                ...
                <div className="absolute -left-6 md:-left-9 top-0 flex items-start">
                  <div className="w-4 h-4 bg-[#8b4513] rounded-full relative z-10">
                    <div className="absolute inset-0 bg-[#8b4513] rounded-full animate-ping opacity-30"></div>
                  </div>
                  <div className="h-full w-px bg-gradient-to-b from-[#8b4513] to-transparent ml-1.5"></div>
                </div>

                {/* Main Experience Card */}
                <div className="ml-0 md:ml-4">
                  <div className="bg-white/90 backdrop-blur-sm border border-[#e0d8ce] 
                                hover:border-[#8b4513] transition-all duration-500 
                                overflow-hidden group-hover:shadow-2xl">
                    
                    {/* Card Header */}
                    <div className="p-8 border-b border-[#e0d8ce] relative">
                      ...
                      <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                          ...
                          <div className="flex items-center gap-4">
                            <div>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-lg text-[#8b4513] font-medium tracking-wide">
                                  {exp.company}
                                </span>
                              </div>
                            </div>
                        ...
                        <div className="flex gap-2">
                            <div className="p-2 border border-[#8b4513] text-[#8b4513] bg-white/50 rounded-lg group text-sm">
                    ...
                    <div className="p-8">
                      {/* Description */}
                      <div className="mb-10">
                        <p className="text-[#403D39] text-lg leading-relaxed font-light">
                          {exp.description}
                        </p>
                      </div>
                      ...
                      <div>
                        <div className="flex items-center gap-3 mb-6">
                          <div className="w-8 h-px bg-[#8b4513]"></div>
                          <h4 className="text-sm font-medium text-[#777] tracking-wider uppercase">
                        ...
                        <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-4">
                          {exp.technologies.map((tech, idx) => (
                            <div
                              key={idx}
                              className="group/tech relative p-4 border border-[#e0d8ce] 
                    ...
                    {/* Card Footer */}
                    <div className="border-t border-[#e0d8ce] p-6 bg-[#f5f1ea]/30">
                        ...
                        <div className="flex items-center gap-2">
                          <div className="flex gap-1">
                            {[...Array(3)].map((_, i) => (
                              <div 
                                key={i} 
                                className="w-1 h-1 bg-[#8b4513] rounded-full opacity-40"
                              ></div>
                            ))}
                          </div>
                          <span className="text-xs text-[#777] tracking-widest">
                            {exp.type}
                          </span>
                        </div>
                      </div>
                  ...
                  {index < listExperience.length - 1 && (
                    <div className="h-12 w-px bg-gradient-to-b from-[#8b4513]/20 to-transparent 
                                  ml-6 md:ml-10"></div>
                  )}
                </div>
              </div>
        ...
        <div className="mt-24 text-center">
          <div className="inline-block relative">
            {/* Decorative Circles */}
            <div className="absolute -top-6 -left-6 w-12 h-12 border border-[#8b4513]/10 rounded-full"></div>
